        ...
        <>
            ...
            <div className="container p-4">
                <div className="row d-flex justify-content-center align-items-center">
                    ...
                    <div className="col-sm-6 pt-4 info-text-start"><h3>Vi erbjuder färg till trädgården och inne. Så du och dina växter alltid har det allra bästa.</h3></div>
                </div>


                <div className="row info-row-start d-flex justify-content-center align-items-center">
                    <div className="col-sm-6"><h3 className="pt-4 info-text-start">Våra växer kommer med näring och vägledning hur du ska ta hand om dom. Bra va?</h3></div>
                    <div className="col-sm-6">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center p-3">
                <h1 className="pb-3 pt-3 info-text-start text-center">TRÄDGÅRDS- & LANDSKAPSDESIGN</h1>
                    ...
                    <div className="row g-0 m-0">
                        ...
                        <div className="col-md-5 bg-landscaping">
                            <div className="card-body ">
                                <h5 className="card-title info-text-start">Planera trädgård - boka hembesök</h5>
                                <p className="card-text info-text-start"> Skapat otaliga Pinterest-boards men vet inte var du ska börja för att skapa din drömträdgård? Misströsta inte, vi finns här för att hjälpa dig!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="d-flex flex-column justify-content-center align-items-center p-5">
                <h1 className="pb-3 info-text-start text-center">VAD KAN VI HJÄLPA DIG MED?</h1>
                <p className="info-text-start text-center text-justify"> Är du på jakt efter livets finaste kruka eller försöker du rädda en döende växt? <br/> Vilket som finns vi alltid på plats för dina frågor om blommor och växter! </p>
                ...
                <div className="d-flex flex-lg-row flex-column">
                    ...
                    <div className="card m-2" style={{ width: "18rem" }}>
                        ...
                        <div className="card-body d-flex flex-column justify-content align-items-center">
                            ...
                            <p className="card-text text-center info-text-start">Sätt färg på trädgården med vackra blommor.</p>
                        </div>
                    </div>
                    ...
                    <div className="card m-2" style={{ width: "18rem" }}>
                        ...
                        <div className="card-body d-flex flex-column justify-content align-items-center">
                            <h5 className="card-title text-center info-text-start">Gödsel och näring</h5>
                            <p className="card-text text-center info-text-start">Ge dina växter gödsel och näring i år.</p>
                        </div>
                    </div>
                    ...
                    <div className="card m-2" style={{ width: "18rem" }}>
                        ...
                        <div className="card-body d-flex flex-column justify-content align-items-center">
                            ...
                            <p className="card-text text-center info-text-start">Botanisera bland säsongens nya krukor!</p>
                        </div>
                    </div>
                ...
                <div className="d-flex flex-column justify-content-center align-items-center p-lg-5">
                    <h1 className="pb-3 pt-5 info-text-start">@GRONAVÄXTER</h1>
